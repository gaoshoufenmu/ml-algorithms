...
$$\begin{aligned} & sw (K_{11} - K_{12}) - y_2(v_1 -v_2) + 1 - s \\ & = sw (K_{11} - K_{12}) + y_2[f_1 - b^{(p)}  - y_1 K_{11} \alpha_1^{(p)} - y_2 K_{12} \alpha_2^{(p)} - f_2 + b^{(p)} + y_1 K_{12} \alpha_1^{(p)} + y_2 K_{22} \alpha_2^{(p)}] + 1 - s \\ & = sw(K_{11}-K_{12}) + y_2[f_1 - f_2 - y_1(K_{11} - K_{12}) \alpha_1^{(p)} - y_2(K_{12} - K_{22}) \alpha_2^{(p)}] + 1 - s \\ & = sw(K_{11} - K_{12}) + y_2(f_1- f_2) - y_1y_2(K_{11} - K_{12}) \alpha_1^{(p)} - y_2^2(K_{12} - K_{22})\alpha_2^{(p)} + 1 - s \\ & = sw(K_{11} - K_{12}) + y_2(f_1 -f_2) - s(K_{11} - K_{12})(w - s \alpha_2^{(p)}) - (K_{12} - K_{22}) \alpha_2^{(p)} + 1 -s \\ & = y_2(f_1 - f_2)  + (K_{11} - K_{12}) \alpha_2^{(p)} - (K_{12} - K_{22}) \alpha_2^{(p)} + 1 - s \\ & = y_2(f_1 -f_2) (K_{11} + K_{22} - 2K_{12}) \alpha_2^{(p)} + y_2^2 - y_2y_1 \\ & = (K_{11} + K_{22} - 2 K_{12}) \alpha_2^{(p)} + y_2[f_1 - y_1 - (f_2 - y_2)] \end{aligned}$$
